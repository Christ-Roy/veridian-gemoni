...
interface LogoCarouselWrapperProps {
  columnCount?: number;
  logos: Logo[];
}

export function LogoCarouselWrapper({ columnCount = 4, logos }: LogoCarouselWrapperProps) {
  ...
  useEffect(() => {
    const logosWithIds = logos.map((logo, idx) => ({ ...logo, id: idx }));
