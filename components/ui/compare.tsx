    ...
    >
      <AnimatePresence initial={false}>
        ...
        >
          ...
          {showHandlebar && (
            <div className="h-5 w-5 rounded-md top-1/2 -translate-y-1/2 bg-background z-30 -right-2.5 absolute flex items-center justify-center border border-border">
